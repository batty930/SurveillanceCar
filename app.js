...
signalingUrl: getParam('signal', 'wss://your-server.example.com/ws'),
hlsUrl: getParam('hls', 'https://your-server.example.com/live/agv.m3u8'),
mjpegUrl: getParam('mjpeg', 'https://your-server.example.com/stream.mjpg'),
controlWs: getParam('control', 'wss://your-server.example.com/agv/control'), // 遙控用
apiBase: getParam('api', 'https://your-server.example.com/api'), // 截圖用
authToken: getParam('token', ''),
};
